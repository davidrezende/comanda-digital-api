...
public final class CardValidation {
    ...
    public static final String STORE_FK_VALIDATION_MESSAGE            =         "Estabelecimento invalido";
    public static final String USER_FK_VALIDATION_MESSAGE             =         "Usuario invalido";
    public static final String CARD_VALIDATION_MESSAGE                =         "Comanda inválida";
}
